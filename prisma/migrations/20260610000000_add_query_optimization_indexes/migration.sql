...
CREATE INDEX IF NOT EXISTS "image_proposals_status_createdAt_idx" ON "image_proposals" ("status", "created_at");

-- Contribution compound index: Same pattern for contribution listings
CREATE INDEX IF NOT EXISTS "contributions_status_createdAt_idx" ON "contributions" ("status", "created_at");
