 ...
 * 
 * Wraps Next.js Image with error handling to gracefully handle broken images.
 * Shows a placeholder icon or hides entirely when image fails to load.
 * 
...
export function SafeImage({
  ...
  // If no src provided or error occurred
  if (!src || error) {
    if (fallback === "hide") {
      return null;
    }
