...
function EcosystemServicesContent({
  ...
  const t = {
    ...
    step3Title:
      locale === "es" ? "🎮 Conecta los Servicios" : "🎮 Connect the Services",
    step4Title: locale === "es" ? "Árboles y Sus Usos" : "Trees and Their Uses",
    step5Title: locale === "es" ? "🎨 Crea Tu Póster" : "🎨 Create Your Poster",
    ...
    dragHere: locale === "es" ? "Arrastra aquí" : "Drag here",
    matched: locale === "es" ? "pareados" : "matched",
    discoveredServices:
      locale === "es" ? "Servicios Descubiertos" : "Services Discovered",
    printPoster: locale === "es" ? "🖨️ Imprimir Póster" : "🖨️ Print Poster",
    addToPoster: locale === "es" ? "Agregar al Póster" : "Add to Poster",
  };
  ...
  const treeUseCategories = [
    { id: "all", label: locale === "es" ? "Todos" : "All", icon: "🌳" },
    { id: "food", label: locale === "es" ? "Alimento" : "Food", icon: "🍎" },
    {
      id: "medicine",
    ...
    {
      id: "construction",
      label: locale === "es" ? "Construcción" : "Construction",
      icon: "🏗️",
    },
    { id: "shade", label: locale === "es" ? "Sombra" : "Shade", icon: "☀️" },
  ];
