...
export default function DiagnoseClient() {
    ...
    return [
      {
        ...
        label: t("leaves"),
        icon: "🍃",
        description: t("leavesDescription"),
      },
      {
        id: "bark" as SymptomCategory,
        label: t("bark"),
        icon: "🪵",
        description: t("barkDescription"),
      },
      {
      ...
      },
      {
        ...
        label: t("wholeTree"),
        icon: "🌳",
        description: t("wholeTreeDescription"),
      },
    ];
  };

  const getSymptoms = (category: SymptomCategory) => {
    const symptoms: Record<SymptomCategory, Record<"en" | "es", string[]>> = {
      leaves: {
        en: [
    ...
    return symptoms[category]?.[locale as "en" | "es"] || [];
  };
  ...
  const getDiagnosis = (
    ...
    const diagnoses: Record<string, Record<"en" | "es", Diagnosis>> = {
      "leaves-yellow": {
        en: {
