...
export default function TreeMapClient({ locale }: TreeMapClientProps) {
  ...
  // Helper to render a collection card with current context
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {featuredCollections
                  .slice(0, 1)
                  .map((collection) =>
                    renderCollectionCard(collection, "large")
                  )}
                {featuredCollections
                  .slice(1, 3)
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {DISCOVERY_COLLECTIONS.filter((c) => c.type === "seasonal").map(
                  (collection) => renderCollectionCard(collection)
                )}
              </div>
            </section>
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="text-xs text-muted-foreground">
                            {getEcosystemLabel(area.type, typedLocale)}
                          </div>
                        </div>
                      </li>
                    ))}
