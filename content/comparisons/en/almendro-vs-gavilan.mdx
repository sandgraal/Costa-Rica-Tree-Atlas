...
seasonalNote: "Fruits help Dec-Mar (almendro) vs explosive pods in dry season (gavilán); leaf type works year-round."
difficulty: "moderate"
...
<SideBySideImages
  ...
  leftLabel="Almendro"
  rightLabel="Gavilán"
  caption="Once-pinnate leaves vs feathery bipinnate foliage"
/>

<QuickDecisionFlow
  steps={[
    {
      question: "What type of leaves does it have?",
      options: [
        {
          answer: "Twice-pinnate feathery with many tiny leaflets",
          result: "Gavilán",
        },
        {
          answer: "Once-pinnate with 5-9 large leaflets",
          result: "Almendro",
        },
      ],
    },
    {
      question: "What type of fruits do you see?",
      options: [
        {
          answer: "Huge flat explosive pods (25-50 cm)",
          result: "Definitely Gavilán",
        },
        {
          answer: "Single drupes with vanilla/coumarin scent",
          result: "Definitely Almendro",
        },
      ],
    },
  ]}
