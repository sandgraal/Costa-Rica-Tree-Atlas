...
seasonalNote: "Easiest during fruiting: Mar-Jun (marañón) vs Apr-Aug (mango). Leaf tip shape helps year-round."
difficulty: "moderate"
...
<SideBySideImages
  ...
  leftLabel="Mango"
  rightLabel="Marañón"
  caption="Single mango fruit vs cashew apple with attached nut"
/>
...
<QuickDecisionFlow
  ...
  steps={[
    {
      question: "Is there a nut attached to a fleshy apple?",
      yesAnswer: "Kidney-shaped nut at the bottom",
      noAnswer: "Single large mango fruit",
      yesResult: "Marañón",
      noResult: "Mango",
    },
    {
      question: "Are the leaf tips rounded?",
      yesAnswer: "Rounded to slightly notched",
      noAnswer: "Pointed, acuminate",
      yesResult: "Marañón",
      noResult: "Mango",
    },
  ]}
