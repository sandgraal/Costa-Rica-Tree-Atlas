...
<PropertiesGrid
  ...
  items={[
    ...
    { label: "Soil Preference", value: "Deep, fertile alluvial soils" },
    { label: "Light Requirement", value: "Partial shade to full sun" },
    { label: "Forest Position", value: "Mid-canopy to sub-canopy (15-25 m)" },
  ]}
/>
