...
<ImageGallery>
  <ImageCard
    ...
    alt="Eugenia stipitata fruit"
    title="Arazá Fruit"
    credit="(c) iNaturalist user, some rights reserved (CC BY-NC)"
    license="CC BY-NC"
  ...
  <ImageCard
    ...
    alt="Eugenia stipitata mature fruit"
    title="Ripe Arazá"
    credit="(c) iNaturalist user, some rights reserved (CC BY-NC)"
    license="CC BY-NC"
    sourceUrl="https://www.inaturalist.org/taxa/327819-Eugenia-stipitata/browse_photos"
