...
toxicityDetails: "Non-toxic. Fruit is edible when ripe and safe for human consumption. High in vitamin C."
skinContactDetails: "No known skin irritation. Safe to handle."
safetyNotes: "Completely safe fruit tree. Ripe fruits are edible but extremely sour—best used in processed forms (juices, ice cream, preserves). No toxicity to humans or pets. Myrtaceae family member with similar safety profile to guava."
---
...
**Sources:** [FAO - _Eugenia stipitata_ (Neglected Crops)](https://www.fao.org/4/V1490E/v1490e0h.htm), [CABI Compendium - _Eugenia stipitata_](https://www.cabidigitallibrary.org/doi/10.1079/cabicompendium.21994), [World Agroforestry species profile](https://apps.worldagroforestry.org/treedb2/speciesprofile.php?Spid=858)
