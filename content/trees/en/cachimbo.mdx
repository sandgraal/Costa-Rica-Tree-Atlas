...
safetyNotes: "Cachimbo is a safe species for general contact but should be planted with consideration for its eventual massive size. The tree is most appropriate for forest restoration and large natural areas. Currently assessed as Least Concern by IUCN, though localized populations may face logging pressure — check national and regional regulations before harvesting timber."
...
commonProblems:
  ...
  - "Localized populations susceptible to logging pressure and habitat destruction"
...
<QuickRef
  ...
  items={[
    ...
    { label: "Conservation Status", value: "Least Concern (IUCN)" },
...
**Timber Caution**: Although globally assessed as Least Concern by IUCN, localized populations face overharvesting pressure. Logging should only occur under sustainable forestry management plans with certification (FSC or equivalent), particularly in fragmented Costa Rican forests.
...
**Sources:** [IUCN Red List](https://www.iucnredlist.org/), [GBIF](https://www.gbif.org/species/3083111), [RNGR species profile](https://rngr.net/), [POWO (Kew)](https://powo.science.kew.org/)
...
**Conservation Status**: Cachimbo is currently assessed as Least Concern globally by IUCN, reflecting its wide range across Central and South America. However, this global status masks meaningful local pressure: its slow growth rate and requirement for primary forest conditions make populations difficult to restore once depleted, and Costa Rican populations face logging pressure that the global assessment does not capture.
...
**Population Trend**: Decreasing in parts of its range  
**Scope**: Global assessment — does not capture regional logging pressure in Costa Rica
...
**Sources:** [IUCN Red List](https://www.iucnredlist.org/), [GBIF](https://www.gbif.org/species/3083111), [SINAC](https://www.sinac.go.cr/), [Rainforest Alliance](https://www.rainforest-alliance.org/)
...
<Callout type="warning" title="Conservation Note">
  Although globally assessed as **Least Concern** by the IUCN, Cachimbo faces
  meaningful local pressure from habitat loss and unsustainable logging in Costa
  Rica. Please support conservation of primary rainforests and sustainable
  forestry practices. This magnificent emergent tree is irreplaceable in
  rainforest ecosystems and takes centuries to reach full maturity.
</Callout>
