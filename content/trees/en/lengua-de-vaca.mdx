...
<DataTable
  ...
  rows={[
    ...
    [
      "Habitat",
      "Cloud forest gaps, roadsides, 500-2500 m",
...
- **Source trees**: Select fruiting individuals from at least 5 separate populations across elevations (800, 1200, 1600, 2000 m) to capture genetic breadth
