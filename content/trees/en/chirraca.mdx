  ...
  images={[
    {
      ...
      alt: "Chirraca tree growing in tropical dry forest",
      caption:
        "A mature Chirraca tree in its natural habitat, occupying a mid-story position beneath the forest canopy",
    },
    {
      src: "/images/trees/chirraca/02-pinnate-leaves.jpg",
      alt: "Distinctive pinnate compound leaves of the Chirraca tree",
      caption:
        "The elegant pinnate compound leaves with regularly arranged leaflets, typical of this legume tree",
    },
    {
      src: "/images/trees/chirraca/03-trunk-detail.jpg",
      alt: "Straight trunk with relatively smooth gray-brown bark",
      caption:
        "The straight trunk of a medium-sized Chirraca tree with smooth bark",
    },
    {
      src: "/images/trees/chirraca/04-inflorescence.jpg",
      alt: "Hanging clusters of small purple Chirraca flowers",
      caption:
        "Pendulous flower clusters (racemes) with numerous small blossoms along the branches",
    },
    {
      src: "/images/trees/chirraca/05-fruits.jpg",
      alt: "Dry, flattened seed pods of the Chirraca tree",
      caption:
        "Mature pods containing seeds that help regenerate tropical dry forest habitats",
    },
  ]}
/>
...
- _**Gliricidia sepium**_ (Madre de Cacao): Similar pink pea-flowers but blooms earlier, has larger leaflets, and is more widely planted
- _**Lonchocarpus**_ species: Several other _Lonchocarpus_ species occur in Costa Rica; specific identification requires examination of flower and fruit details
...
**Sources:** [IUCN Red List — _Lonchocarpus minimiflorus_ search](https://www.iucnredlist.org/search?query=Lonchocarpus%20minimiflorus), [GBIF — _Lonchocarpus minimiflorus_](https://www.gbif.org/species/2944192), [Área de Conservación Guanacaste](https://www.acguanacaste.ac.cr/)
...
- **Fast-growing canopy partners**: _Enterolobium cyclocarpum_ (Guanacaste), _Pachira quinata_ (Pochote), _Samanea saman_ (Genízaro)
- **Mid-story companions**: _Tabebuia_ species (Cortez), _Cochlospermum vitifolium_ (Poro-Poro), _Cordia_ species
- **Slower-growing valuable hardwoods**: _Dalbergia retusa_ (Cocobolo), _Swietenia humilis_ (Mahogany)
