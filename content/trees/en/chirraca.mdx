...
<PropertiesGrid
  ...
  items={[
    ...
    { label: "Annual Rainfall", value: "1,000-2,000 mm (strongly seasonal)" },
...
- **Well-drained soil** — tolerates rocky, shallow, and calcareous soils; does not tolerating waterlogging
