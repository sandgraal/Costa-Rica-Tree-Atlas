  ...
  images={[
    {
      ...
      alt: "Chirraca palm growing in tropical forest understory",
      caption:
        "The Chirraca palm in its natural habitat — middle-story position beneath forest canopy",
    },
    {
      src: "/images/trees/chirraca/02-pinnate-leaves.jpg",
      alt: "Distinctive pinnate leaves arranged regularly",
      caption:
        "The elegant pinnate leaves with regularly arranged leaflets — key identification feature",
    },
    {
      src: "/images/trees/chirraca/03-trunk-detail.jpg",
      alt: "Smooth trunk with prominent leaf scars",
      caption: "The slender, ringed trunk marked with neat leaf-scar patterns",
    },
    {
      src: "/images/trees/chirraca/04-inflorescence.jpg",
      alt: "Inflorescence with small flowers",
      caption:
        "Branched inflorescence emerging below the crownshaft with numerous small flowers",
    },
    {
      src: "/images/trees/chirraca/05-fruits.jpg",
      alt: "Dark purple-black mature fruits",
      caption: "Ripe fruits providing important food for forest wildlife",
    },
  ]}
/>
