  ...
  images={[
    {
      ...
      alt: "Bright yellow trumpet-shaped flowers of Tecoma stans",
      caption:
        "The distinctive golden-yellow trumpet flowers that give Sardinillo its ornamental value",
    },
    {
      src: "/images/trees/sardinillo/02-full-plant.jpg",
      alt: "Full view of flowering Sardinillo shrub",
      caption:
        "A mature Sardinillo in full bloom showing the dense flowering habit",
    },
    {
      src: "/images/trees/sardinillo/03-seed-pods.jpg",
      alt: "Long narrow seed pods resembling sardines",
      caption:
        "The characteristic long, narrow seed pods that inspired the name 'Sardinillo' (little sardine)",
    },
    {
      src: "/images/trees/sardinillo/04-foliage.jpg",
      alt: "Pinnately compound leaves with serrated leaflets",
      caption:
        "The bright green, pinnately compound leaves with distinctive serrated margins",
    },
    {
      src: "/images/trees/sardinillo/05-habitat.jpg",
      alt: "Sardinillo growing in natural roadside habitat",
      caption:
        "Naturalized Sardinillo along a Costa Rican roadside, demonstrating its pioneer nature",
    },
  ]}
/>
...
<DataTable
  headers={["Animal Group", "Species/Type", "Interaction"]}
  rows={[
    [
      "Bees",
      "Honeybees (Apis mellifera)",
      "Primary nectar and pollen collectors; excellent honey plant",
    ],
    [
      "Bees",
      "Stingless bees (Meliponini)",
      "Native bee guild; critical pollinators throughout flowering season",
    ],
    [
      "Bees",
      "Carpenter bees (Xylocopa)",
      "Effective pollinators; buzz pollination increases seed set",
    ],
    [
      "Birds",
      "Hummingbirds",
      "Nectar feeders; territorial defense around flowering plants",
    ],
    [
      "Butterflies",
      "Swallowtails (Papilionidae)",
      "Nectar feeders during peak flowering periods",
    ],
    [
      "Butterflies",
      "Sphinx moths (Sphingidae)",
      "Larvae feed on foliage; adults pollinate flowers",
    ],
    ["Insects", "Leaf-cutter ants", "Occasional foliage harvesters"],
    [
      "Birds",
      "Small passerines",
      "Use dense branches for nesting sites and shelter",
    ],
  ]}
/>
...
- **vs. _Handroanthus ochraceus_ (Yellow Corteza)**: Sardinillo has persistent foliage with smaller flowers (4-5 cm vs. 8-12 cm); Yellow Corteza is deciduous with massive flowering bursts on bare branches
- **vs. _Senna spectabilis_ (Canary Flower)**: Sardinillo has pinnate leaves with narrow leaflets and trumpet-shaped flowers; Senna species have broader leaflets and open yellow flowers with 5 rounded petals
- **vs. _Cassia fistula_ (Golden Shower)**: Sardinillo produces upright clusters with few flowers; Golden Shower has spectacular hanging clusters 30-60 cm long
- **vs. Golden Shrimp Plant (_Pachystachys lutea_)**: The latter has overlapping bracts rather than true trumpet flowers
...
**Sources:** [iNaturalist observations](https://www.inaturalist.org/taxa/48363-Tecoma-stans), [GBIF species profile](https://www.gbif.org/species/3172390), [Tropicos](https://www.tropicos.org/name/3700620), [Gentry (1992)](https://www.jstor.org/stable/4393885)
...
**Sources:** [IUCN Red List](https://www.iucnredlist.org/), [GBIF species profile](https://www.gbif.org/species/3172390), [World Flora Online](https://www.worldfloraonline.org/), [iNaturalist observations](https://www.inaturalist.org/taxa/48363-Tecoma-stans)
