...
<DataTable
  ...
  rows={[
    [
      "Leaf type",
      "Even-pinnate, 10-20 pairs of tiny leaflets",
      "Bifoliolate (2 large leaflets)",
      "Simple, opposite leaves",
    ],
    [
      "Leaflet size",
      "Tiny (1-2 cm each); leaflets close at night",
      "Large (5-10 cm each)",
      "N/A — entire leaf 5-10 cm",
    ],
    [
      "Fruit",
      "Brown curved pod 5-15 cm; pulp around seeds",
      "Large woody pod 8-15 cm; sweet resinous pulp",
      "Round green berry 3-5 cm; acidic pulp",
    ],
    [
      "Bark",
      "Dark gray-brown, rough, deeply fissured",
      "Smooth gray, slightly flaking",
      "Smooth, reddish-brown, peeling",
    ],
    [
      "Crown shape",
    ...
    [
      "Typical habitat",
      "Dry lowlands, plazas, roadsides",
      "Wet and dry forests, lowland to premontane",
      "Gardens, hedgerows, disturbed areas",
    ],
    [
      "Deciduousness",
      "Semi-deciduous in severe dry seasons",
...
<DataTable
  ...
  rows={[
    [
      "Shell removal",
      "Crack brittle shell by hand; peel away",
      "Discard damaged or moldy pods",
    ],
    [
      "Deseeding",
      "Squeeze pulp mass; separate seeds by hand",
      "Seeds are very hard; can be saved for planting",
    ],
    [
      "Pulp preparation",
      "Soak pulp in warm water 30 min; strain through sieve",
      "Produces concentrated tamarind paste",
    ],
    [
      "Preservation",
      "Compress paste into blocks; wrap in plastic; refrigerate",
      "Keeps 6-12 months refrigerated; freezes well",
    ],
    [
      "Beverage (agua de tamarindo)",
      "Dissolve paste in water; add sugar to taste; ice",
      "Iconic Costa Rican refreshment",
    ],
    [
      "Confection",
      "Roll paste balls in sugar; dry slightly",
      "Popular candy (tamarindo con chile)",
    ],
  ]}
/>
...
<DataTable
  ...
  rows={[
    [
      "Sowing",
      "After scarification",
      "2-3 cm deep in well-drained nursery bags",
      "One seed per bag; keep moist",
    ],
    [
      "Germination",
      "5-10 days",
      "25-35°C; full sun",
      "Very high germination rate (>90%)",
    ],
    [
      "Seedling growth",
      "4-8 months",
      "Full sun; moderate watering",
      "Fast grower; 30-60 cm in first growing season",
    ],
    [
      "Field-ready",
      "6-12 months",
      "Seedling 40-80 cm, sturdy stem",
      "Plant at onset of rainy season (May-Jun)",
    ],
  ]}
/>
