...
>
  ...
  therefore classified as **Not Evaluated (NE)** in our schema. However,
  regional assessments treat the species as **Vulnerable** in Costa Rica due to
  significant habitat loss in lowland tropical forests. Wild populations are
  fragmented and declining. The species requires conservation attention both as
  a component of tropical biodiversity and as a critical genetic resource for
  global agriculture.
</Callout>
