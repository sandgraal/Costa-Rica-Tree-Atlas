...
<PropertiesGrid
  ...
  items={[
    ...
    { label: "Elevation", value: "800-2,500 m" },
    {
      label: "Climate Zones",
...
<PropertiesGrid
  ...
  items={[
    { label: "Elevation Range", value: "800-2,500 m" },
    { label: "Annual Rainfall", value: "2,000-4,000+ mm (plus cloud drip)" },
    { label: "Temperature Range", value: "12-24°C" },
    { label: "Soil Preference", value: "Deep, fertile volcanic soils" },
    {
      label: "Light Requirement",
      value: "Partial shade (juvenile) to full sun (adult)",
    },
    { label: "Forest Position", value: "Canopy emergent (30-45 m)" },
  ]}
/>
