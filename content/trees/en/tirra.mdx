...
<DataTable
  ...
  rows={[
    [
      "Height at maturity",
      "30-45 m (emergent canopy)",
      "5-12 m (small pioneer)",
      "15-30 m (canopy tree)",
    ],
    [
      "Leaf base",
      "Asymmetric (classic elm feature)",
      "Symmetric, serrate margin",
      "Symmetric, entire margin",
    ],
    [
      "Leaf texture",
      "Slightly rough above (scabrous)",
      "Soft, hairy",
      "Smooth, aromatic when crushed",
    ],
    [
      "Bark",
      "Deeply furrowed, thick, gray-brown",
      "Smooth, thin, grayish",
      "Smooth to finely fissured",
    ],
    [
      "Fruit",
      "Winged samara (dry, papery)",
      "Small round berry (red, edible)",
      "Berry set in a cupule (Lauraceae)",
    ],
    [
      "Deciduousness",
      "Semi-deciduous; sheds leaves Jan-Apr",
      "Evergreen or briefly deciduous",
      "Evergreen",
    ],
    [
      "Buttresses",
      "Present on large trees (1-2 m)",
      "None",
      "Occasional, small",
    ],
    [
      "Elevation",
      "800-2,500 m (cloud forest)",
      "0-1,500 m (lowland to premontane)",
      "1,000-3,000 m (premontane to montane)",
    ],
  ]}
/>
...
<DataTable
  ...
  rows={[
    [
      "Specific gravity",
      "0.55-0.65",
      "Medium-dense hardwood; strong but workable",
    ],
    [
      "Heartwood color",
      "Yellowish to golden-brown",
      "Attractive appearance for furniture",
    ],
    [
      "Grain",
      "Interlocking",
      "Resists splitting; ideal for joinery and wheels",
    ],
    [
      "Durability",
      "Moderate to good",
      "Suitable for construction with treatment",
    ],
    [
      "Workability",
      "Good",
      "Takes excellent finish with hand and machine tools",
    ],
    ["Drying", "Moderate difficulty", "Prone to warping if dried too rapidly"],
  ]}
/>
...
<DataTable
  ...
  rows={[
    [
      "Sowing",
      "Immediate",
      "Shallow (1-2 cm) in moist, well-drained seedbed",
      "Sow within days of collection; viability declines rapidly",
    ],
    [
      "Germination",
      "2-4 weeks",
      "20-22°C; partial shade (50-70%); keep moist",
      "Fresh seeds germinate readily",
    ],
    [
      "Seedling growth",
      "6-12 months",
      "Partial shade; rich organic potting mix",
      "30-50 cm growth in first year",
    ],
    [
      "Field-ready",
      "8-14 months",
      "Seedling height 30-50 cm, well-rooted",
      "Plant under existing canopy or nurse trees",
    ],
  ]}
/>
...
1. **Dutch Elm Disease preparedness**: Develop surveillance protocols and contingency plans for the potential arrival of _Ophiostoma_ pathogens in Central America
...
<DataTable
  headers={["Parameter", "Assessment", "Score (1-5)"]}
  rows={[
    ["Crown condition", "Full / Thinning / Dieback", "_____"],
    ["Bark beetle galleries present?", "Yes / No", "_____"],
    ["Fungal cankers on trunk?", "Yes / No", "_____"],
    ["Epiphyte load (orchids, bromeliads)", "Low / Medium / High", "_____"],
    ["Buttress integrity", "Solid / Damaged / Hollow", "_____"],
    [
      "Regeneration nearby (seedlings <1 m)",
      "Absent / Sparse / Abundant",
      "_____",
    ],
    ["Canopy connectivity", "Isolated / Linked / Continuous", "_____"],
  ]}
/>
