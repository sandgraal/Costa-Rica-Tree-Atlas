...
<QuickRef
  ...
  items={[
    { label: "Scientific Name", value: "Avicennia germinans" },
    { label: "Family", value: "Acanthaceae" },
    { label: "Max Height", value: "15-25 m (50-80 ft)" },
    { label: "Growth Rate", value: "Moderate (2-3 ft/year)" },
    { label: "Light", value: "Full sun" },
    { label: "Water Needs", value: "High - upper intertidal zone" },
    { label: "Soil", value: "Saline to hypersaline mud" },
