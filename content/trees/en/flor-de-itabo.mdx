...
<QuickRef
  ...
  items={[
    ...
    { label: "Native Region", value: "Mexico and Central America" },
    {
      ...
      value: "Data Deficient (IUCN); abundant in cultivation",
    },
...
_Yucca guatemalensis_ (also widely treated under the synonyms _Y. gigantea_ Lem. and _Y. elephantipes_ Regel ex Trel.) is currently **Data Deficient (DD)** on the IUCN Red List — the assessment reflects taxonomic uncertainty about the species' wild range, not a population concern. In cultivation, the species is abundant across Central America and far beyond, with extreme ease of propagation; living fences and edible-flower plantings ensure broad ex situ representation. Wild populations on rocky slopes and dry forests of southern Mexico and Guatemala are not known to be in decline, but rigorous wild-population data is what the DD status is asking for.
