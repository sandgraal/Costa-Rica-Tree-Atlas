...
<QuickRef
  ...
  items={[
    ...
    { label: "Conservation Status", value: "Not Evaluated (IUCN)" },
...
**Status**: Not Evaluated (NE) — no current global IUCN assessment for _Brosimum utile_ <Reference href="https://www.gbif.org/species/8042591" title="GBIF: Brosimum utile" />.  
**Population Trend**: Locally declining in accessible primary forest; stable in protected reserves <Reference href="https://www.sinac.go.cr" title="SINAC — Sistema Nacional de Áreas de Conservación" />.  
**Assessment**: GBIF reflects no formal Red List entry; regional pressure is documented through national forestry records and SINAC management plans rather than an IUCN dossier <Reference href="https://www.iucnredlist.org/search?query=Brosimum%20utile" title="IUCN Red List search — Brosimum utile" />.
