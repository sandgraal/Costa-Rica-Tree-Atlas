...
<QuickRef
  ...
  items={[
    ...
    { label: "Native Region", value: "Central America and Andes" },
    {
      ...
      value: "Not Evaluated by IUCN; local populations face pressures",
    },
...
_Vasconcellea cauliflora_ has not been formally assessed by the IUCN Red List and is therefore classified as **Not Evaluated (NE)** in our schema. The species is widely distributed across Central America and the northern Andes, with no known immediate threat to its global persistence. Local populations, however, face pressures:
