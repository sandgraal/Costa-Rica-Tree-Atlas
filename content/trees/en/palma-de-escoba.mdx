...
>
  _Cryosophila albida_ has no formal global assessment on the IUCN Red List to
  date and is therefore classified as **Not Evaluated (NE)** in our schema.
  However, regional assessments and Costa Rican botanical literature
  consistently treat the species as **Vulnerable** due to the combined impacts
  of deforestation, habitat fragmentation, and unsustainable leaf harvesting.
  Wild populations have declined significantly, particularly in accessible
  lowland areas. The species' slow growth rate and dependence on mature forest
  make recovery challenging.
</Callout>

**Sources:** [GBIF species profile — _Cryosophila albida_](https://www.gbif.org/species/2732474),
[IUCN Red List search — _Cryosophila albida_](https://www.iucnredlist.org/search?query=Cryosophila%20albida),
