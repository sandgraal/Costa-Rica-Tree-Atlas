...
<TwoColumn>
  <QuickRef
    ...
    lifespan="30-50 años"
    growthRate="Rápido"
    nativeRange="México a Colombia"
    elevationRange="0-1000 m"
    climaticZone="Bosque seco tropical"
    rainfall="800-2000 mm/año"
    soilType="Bien drenado, varios tipos"
    sunRequirement="Sol pleno"
    floodTolerance="Moderada"
    droughtTolerance="Alta"
    fireResistance="Baja"
    conservationStatus="Preocupación Menor (LC)"
    commercialValue="Bajo a moderado"
    woodDensity="650-750 kg/m³"
    woodColor="Duramen marrón rojizo"
    commonUses="Cercas vivas, control de erosión, investigación"
    specialFeatures="Simbiosis con hormigas, fijación de nitrógeno"
  />
  <INaturalistEmbed
