...
| P2       | Performance Phase 3  | 🟡 In progress       | 10 server component conversions done (Footer, CurrentYear, FeaturedTrees, SafeJsonLd, HeroImage, SafetyCard, SafetyDisclaimer, Breadcrumbs + 3 dead code deleted). SafetyIcon/QRCodeGenerator blocked (imported by client components). Remaining: ~55 client components, partial hydration, progressive enhancement, edge caching |
