...
- **2026-02-14 update:** Maintenance rerun completed (`npm run content:audit`) and highest-impact bilingual gaps were reduced.
  - Expanded `content/trees/es/granadillo.mdx` from 167 → 973 lines (EN counterpart 879).
  - Expanded `content/trees/es/ira-rosa.mdx` from 341 → 769 lines (EN counterpart 749).
