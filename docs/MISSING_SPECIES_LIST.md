...
- **Granadillo** - _Dalbergia tucurensis_ - Guatemalan Rosewood, vulnerable (distinct from _D. retusa_ **Cocobolo** already documented; often misidentified as "Cocobolo Prieto" which is D. retusa)
...
- High-quality images (featured + gallery)
...
- Botanical references (Flora Costaricensis, Tropical Trees of Costa Rica)
- iNaturalist observations for images
- IUCN Red List for conservation status
- Local expertise for cultural/traditional use information
- Spanish translators for bilingual content

## See Also

- [CONTENT_STANDARDIZATION_GUIDE.md](./CONTENT_STANDARDIZATION_GUIDE.md) - Content structure standards
- [improvement-roadmap.md](./improvement-roadmap.md) - Current project status
