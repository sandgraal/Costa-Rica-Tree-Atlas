...
└─────────────────────────────────────────────────────────────┘
                            ↓
┌─────────────────────────────────────────────────────────────┐
│ 2. REVIEW LAYER (Admin Approval)                            │
│    - Admin dashboard shows proposals                         │
...
└─────────────────────────────────────────────────────────────┘
                            ↓
┌─────────────────────────────────────────────────────────────┐
│ 3. CROWDSOURCE LAYER (User Voting)                          │
│    - Public voting page (no login required)                 │
│    - Flag mislabeled images (leaf vs tree mismatch)         │
│    - Upvote/downvote image quality                          │
│    - Feeds into admin review dashboard                      │
└─────────────────────────────────────────────────────────────┘
```
...
2. **Side-by-Side Comparison**
   ...
   ├─────────────────────┼─────────────────────┤
   │ 800×600 (low res)   │ 1920×1440 (hi res) │
   │ Source: iNaturalist │ Source: iNaturalist │
   │ Added: 2025-06-15   │ Found: 2026-01-19  │
   │                     │                     │
   │ User Votes: 3↑ 1↓   │ Quality: 87/100    │
   │ Flags: 2 mismatch   │ Reason: Higher res  │
   └─────────────────────┴─────────────────────┘

   [🗑️ Archive]  [❌ Deny]  [✅ Approve & Apply]
   ```
...
2. **Flag Dialog**
   ...
   ○ Wrong subject (says "leaf" but shows whole tree)
   ○ Poor quality (blurry, dark, unclear)
   ○ Wrong species (doesn't match description)
   ○ Other: [text input]
...
✅ **Control** - Review before changes apply
✅ **Context** - See why change is proposed
✅ **Comparison** - Side-by-side current vs proposed
✅ **Audit trail** - Track all changes
✅ **Batch operations** - Handle multiple proposals efficiently

### For Users

✅ **Participation** - Help improve image quality
✅ **Feedback** - Flag mismatched descriptions
✅ **Transparency** - See what images are being considered
✅ **Recognition** - Leaderboard for contributors

### For System

✅ **Safety** - No automatic overwrites
✅ **Quality** - Human review catches issues
✅ **Scalability** - Crowdsourced quality control
✅ **Compliance** - Full audit trail
✅ **Flexibility** - Easy to adjust quality criteria
