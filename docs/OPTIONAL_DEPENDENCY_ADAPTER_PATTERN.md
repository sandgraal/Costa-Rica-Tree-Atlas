...
**When to use:** The feature (MFA, analytics, etc.) is optional and the dependency may fail to load.

## Guidelines for New Integrations

1. **Never statically import optional dependencies** at the module top level
